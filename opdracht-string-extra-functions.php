...
$needle         =   "o";
$posKokosnoot   =   strpos($fruit,$needle);

#deel 2

$fRuit                   =   'ananas';

$stringTocapitals        =   strtoupper ($fRuit);
    ...
    <body class="web-backend-opdracht">
        ...
        <section class="body">
            ...
            <ul>
                ...
                <pre><?php print_r( $fruitLengte ) ?></pre>
                <pre><?php print_r( $posKokosnoot ) ?></pre>
            </ul>
            ...
            <ul>
                ...
                <pre><?php print_r( $stringTocapitals ) ?></pre>
                <pre><?php print_r( $posA ) ?></pre>
            </ul>
    		...
    		<ul> 
                ...
                <li>Vervang nu alle e’s in de <code>$langsteWoord</code> variable door 3's. 
                    ...
                    <pre><?php print_r( $nieuwWoord ) ?></pre>
                </li>
    		</ul>
