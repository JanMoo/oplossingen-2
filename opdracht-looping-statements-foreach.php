<?php 
$text_file = file_get_contents("./extra/text-file.txt");
$textFileLength = strlen($text_file);
$textChars = array();
for($i = 0; $i< $textFileLength; $i++  )
{
 $textChars[$i] = substr($text_file, $i, 1 );   
}
sort($textChars);
        ...
        <ul>
            ...
            <li>Toon de resultaten op het scherm, bv.
                ...
                <div class="facade-minimal" data-url="http://www.app.local/index.php">
                    ...
                    <ul>
                        <?php foreach($tellerArray as $key => $value):?>

                        <li>
                            <?php echo $key." x ". $value ;?>
                        </li>
